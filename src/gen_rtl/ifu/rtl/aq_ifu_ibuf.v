...
aq_ifu_ibuf_entry  x_aq_ifu_ibuf_entry0 (
  ...
  .ibuf_create0_inst          ({ibuf_create0_inst[15:9],
                                ibuf_create0_inst[9],
                                ibuf_create0_inst[7:0]}   ),
...
assign {entry5_retire0_en,
        ...
        entry2_retire0_en,
        entry1_retire0_en,
        entry0_retire0_en} = pop0[ENTRY_NUM-1:0] & {ENTRY_NUM{ibuf_retire0_en_vld}};
...
//&CombEnd;
assign push0_bypass[ENTRY_NUM-1:0] = ibuf_create1_en && !ibuf_create2_en
                                     ? {push0[ENTRY_NUM-2:0], push0[ENTRY_NUM-1]}
                                     : push0[ENTRY_NUM-1:0];
...
assign {entry5_create0_data_en,
        ...
        entry0_create0_data_en} = push0_bypass[ENTRY_NUM-1:0] &
                             {ENTRY_NUM{ibuf_create0_data_en}};

//push1
assign push1[ENTRY_NUM-1:0] = {push0[ENTRY_NUM-2:0],
                               (push0[ENTRY_NUM-1] &&
                                      (!ibuf_create2_en || !ibuf_retire1_en || ibuf_vld_num != 3))};

//push1
assign push1_bypass[ENTRY_NUM-1:0] = !ibuf_create1_en || ibuf_create2_en
                                     ? {push0_bypass[ENTRY_NUM-2:0],
...
assign {entry5_create1_data_en,
        ...
        entry0_create1_data_en} = push1_bypass[ENTRY_NUM-1:0] &
